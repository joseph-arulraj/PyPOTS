...
#SBATCH --output=/scratch/users/k23031260/PyPOTS/output_logs/Imputation_bayesian_deari.out
#SBATCH --job-name=deari_impute
...
python bayesian_deari.py --mode impute
